...
export const characterList: Character[] = [
  ...
  },
  {
    img: 'Yururu.PNG',
    name: 'Yururu',
    description: 'Gave his life for those in his platoon. Hail Keron!',
    stats: {
      strength: 3,
      dexterity: 5,
      constitution: 3,
